...
Before start you have to set your data in config.json in config.json in root
...
bookSelector - "[attr='value']" - css selector for link to a book on a course page. The hardest option, you should open dev tools on course page and find a html element which navigates you to book page. For example selector for
